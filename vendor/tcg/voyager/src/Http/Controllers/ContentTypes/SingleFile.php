...
class SingleFile extends BaseType
{
    /**
     * @return string
     */
    public function handle()
    {
        ...
        $path = $this->generatePath();
            ...
            $file->storeAs(
                ...
                $filesPath['download_link'] = $path.$filename.'.'.$file->getClientOriginalExtension();
                $filesPath['original_name'] = $file->getClientOriginalName();
