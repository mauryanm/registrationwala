...
@section('page_title', 'Import City')
...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-data"></i>Import Cities
    </h1>
@stop
...
@section('content')
    ...
    @if($errors->any())
        {!! implode('', $errors->all('<div class="alert alert-danger">:message <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a></div>')) !!}
    @endif
    </div>

    <div class="page-content settings container-fluid">
        <form action="{{ route('voyager.cities.import') }}" method="POST" enctype="multipart/form-data">
            {{ method_field("POST") }}
            {{ csrf_field() }}
