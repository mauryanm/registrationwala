      ...
      <ul class="list-reset m0 p0 ampstart-label">
         ...
         <li class="ampstart-nav-item ampstart-nav-dropdown relative">
            ...
            <amp-accordion
               ...
               <section>
                  <header>Start a Business </header>
                  <ul class="ampstart-dropdown-items list-reset m0 p0">
                     <h6 class="mb2 navhead"> Business Registration</h6>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">Company Registration</a> </li>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">Private Limited Company</a> </li>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">One Person Company</a> </li>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">Nidhi Company</a> </li>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">Section 8 Company</a> </li>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">Startup Registration</a> </li>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">Producer Company</a> </li>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">Public Limited Company</a> </li>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">Sole Proprietorship</a> </li>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">Limited Liability Partnership</a> </li>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">Partnership Registration</a> </li>
                  </ul>
               </section>
            </amp-accordion>
            <!-- End Dropdown-inline --> 
         ...
         <li class="ampstart-nav-item ampstart-nav-dropdown relative">
            ...
            <amp-accordion
               ...
               class="ampstart-dropdown" >
               <section>
                  <header>Regulatory Licenses </header>
                  <ul class="ampstart-dropdown-items list-reset m0 p0">
                     <h6 class="mb2 navhead"> Business Registration</h6>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">Company Registration</a> </li>
                     <li class="ampstart-dropdown-item"> <a href="#" class="text-decoration-none">Private Limited Company</a> </li>
         ...
         <li class="ampstart-nav-item"> <a class="ampstart-nav-link" href="#"> Our Blogs</a> </li>
      </ul>
   </nav>
