          ...
          <div class="col-md-8">
            ...
            <div class="bg-light mb-3">
              <div class="row no-gutters">
                <div class="col-md-5"><a href="{{url( __('voyager::post.post_slug').$catData->category->slug.'/'.$catData->slug.'/'.$post->slug)}}"><img src="{{Voyager::image($post->thumbnail('medium'))}}" class="img-fluid border"></a></div>
                <div class="col-md-7">
                  <div class="p-3">
