...
@section('title', "Internal Server Error | Registrationwala")
@section('description', "Internal Server Error | Registrationwala")
@section('keywords', "Internal Server Error | Registrationwala")
@section('content')
...
<div class="container error-container">
    <div class="error">
        <h1>500</h1>
        <h2>error</h2>
        <p>Something just isn't right... Please contact administrator or <a class="btn-link" href="{{url('contact-us')}}">contact us</a> for this error.<span style='font-size:5rem;'>&#128557;</span> </p>
    </div>
