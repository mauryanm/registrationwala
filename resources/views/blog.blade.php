      ...
      <div class="col-md-8 ">
        <div id="blogslider" class="carousel slide" data-ride="carousel"> 
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item {{$loop->first?'active':''}}"> <a href="{{url( __('voyager::post.post_slug').$row->category->slug.'/'.$row->service->slug.'/'.$row->slug)}}"> <img class="d-block img-fluid" src="{{Voyager::image($row->image)}}" alt=""></a>
